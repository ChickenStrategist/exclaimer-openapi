# Exclaimer Cloud API (Curated for MSP Automation)

Official OpenAPI 3.0 specification for Exclaimer API integration with Rewst.
...
- **Version**: v1-curated
- **Base URL**: `https://cloudapi.exclaimer.com`
- **Authentication**: ApiKeyAuth

## Description
Subset covering Subscriptions, Users, Mailboxes, Reference resources and Status for provisioning workflows.
